...
pingdom_auth = {
  :username => ENV['PINGDOM_HOSPITIUM_USER'],
  :password => ENV['PINGDOM_HOSPITIUM_PASS'],
  :key => ENV['PINGDOM_HOSPITIUM_KEY']
}

stashboard_auth = {
  :url          => ENV['STASHBOARD_HOSPITIUM_URL'],
  :oauth_token  => ENV['STASHBOARD_HOSPITIUM_TOKEN'],
  :oauth_secret => ENV['STASHBOARD_HOSPITIUM_SECRET']
}
